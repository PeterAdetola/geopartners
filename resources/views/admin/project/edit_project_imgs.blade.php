...
@section('admin')
@php
$pageTitle = 'Edit Images for '.$project->name;
@endphp
            ...
            <div class="row">
              <div class="col s10 m6 l6">
                ...
                <ol class="breadcrumbs mb-0">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('view.projects') }}">View Projects</a>
                  </li>
                  <li class="breadcrumb-item"><a href="{{ route('edit.project', $project->id) }}">Edit Project</a>
                  </li>
                  <li class="breadcrumb-item active">Edit Project Image</li>
                </ol>
              </div>
  ...
  @foreach($projectImages as $projectImage) 
    ...
    <div class="col s12 m6 l4">
          ...
          <div class="card" style="
              background-image: url('{{ url($projectImage->image) }}');
        ...
        " >
            ...
            <div class="card-action">
              ...
              <a id="delete" href="{{ route('delete.project_img', $projectImage->id) }}" class="modal-trigger lime-text text-accent-1">
    ...
    {{--@include('admin.hero.modals.delete-projectImage-modal')--}}
    @endforeach
